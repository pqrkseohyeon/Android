package com.cookandroid.clientnetdb.Network;

import android.os.AsyncTask;
import android.util.Log;

import com.cookandroid.clientnetdb.Custom_Adapter;
import com.cookandroid.clientnetdb.UserInfo;
...
public class NetworkGet extends AsyncTask<String, Void, String> {
    private URL Url;
    private String URL_Adress = "http://10.100.206.18:8888/testDB/testDB_insert.jsp";
