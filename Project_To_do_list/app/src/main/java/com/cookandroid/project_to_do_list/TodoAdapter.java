...
// MainActivity.java와 RecyclerView 사이를 연결해 준다.
...
public class TodoAdapter  extends RecyclerView.Adapter<TodoAdapter.ViewHolder> {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(@NonNull View itemView) { //itemView와 연결했기 때문에 findViewBYId 앞에 itemView를 명시한다.
            super(itemView);
    ...
    // onVindViewHoler() - position에 해당하는 데이터를 뷰홀더의 아이템뷰에 표시
    @Override
